...
CREATE TABLE `project_subcategory`  (
  ...
  `project_category_id` int NULL DEFAULT NULL COMMENT '属于的项目大类的ID',
  `template_id` int NULL DEFAULT NULL COMMENT '对应的模板的ID',
...
INSERT INTO `project_subcategory` VALUES (5, 4, 5, '智能家居', '2024-07-18 14:00:00', '2024-07-18 14:00:00');
